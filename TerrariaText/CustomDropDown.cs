...
namespace TerrariaText
{
    ...
    class CustomDropDown : UserControl
    {
        ...
        public CustomDropDown()
        {
            ...
            lblText.Font = new Font(Font.FontFamily, 8, FontStyle.Bold);
        ...
        private void PaintDropDpown(object o, DrawItemEventArgs e)
        {
            ...
            e.Graphics.FillRectangle(new SolidBrush(combo.BackColor), new Rectangle(e.Bounds.Location.X, e.Bounds.Location.Y - 2, e.Bounds.Width, e.Bounds.Height + 4));
            if ((e.State & DrawItemState.Selected) == DrawItemState.Selected)
            {
                //e.Graphics.FillRectangle(new SolidBrush(combo.BackColor), new Rectangle(e.Bounds.Location.X, e.Bounds.Location.Y - 2, e.Bounds.Width, e.Bounds.Height + 4));
                e.Graphics.DrawPath(new Pen(Color.Black, 2), GetFigurePath(new Rectangle(e.Bounds.Location.X, e.Bounds.Location.Y, e.Bounds.Width - 1, e.Bounds.Height - 1), 1));

                Font f = new Font(Font.Name, Font.Size, FontStyle.Bold, Font.Unit);
                e.Graphics.DrawString(combo.Items[e.Index].ToString(), f, new SolidBrush(Color.White), new Point(e.Bounds.X + 2, e.Bounds.Y));
            }
            else
            {

                Font f = new Font(Font.Name, Font.Size, FontStyle.Regular, Font.Unit);
        ...
        private void Icon_Paint(object sender, PaintEventArgs e)
        {
            ...
            graph.DrawRectangle(new Pen(Color.Black, 2), new Rectangle(
            ...
            graph.FillPolygon(new SolidBrush(btnIcon.ClientRectangle.Contains(btnIcon.PointToClient(MousePosition)) && !cmbList.DroppedDown ? Color.White : Color.Black), GetDownArrow(new Rectangle(rectIcon.X, rectIcon.Y + 1, rectIcon.Width, rectIcon.Height)));
        }
